...
# direct methods
.method public static final asSequence(Ljava/lang/Iterable;)Landroidx/core/view/ViewGroupKt$children$1;
    .locals 2
...
.method public static final contains(Ljava/util/Collection;Ljava/lang/Object;)Z
    .locals 3
...
.method public static final drop(Ljava/lang/Iterable;)Ljava/util/List;
    .locals 4
    ...
    :cond_7
    invoke-static {v3}, Lkotlin/jvm/JvmClassMappingKt;->optimizeReadOnlyList(Ljava/util/List;)Ljava/util/List;
...
.method public static final dropLast(Ljava/util/List;)Ljava/util/List;
    .locals 1
...
.method public static final filter(Ljava/lang/Iterable;Lkotlin/jvm/functions/Function1;)Ljava/util/ArrayList;
    .locals 3
...
.method public static synthetic joinTo$default(Ljava/lang/Iterable;Ljava/lang/Appendable;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lkotlin/jvm/functions/Function1;I)V
    .locals 8
...
.method public static final last(Ljava/util/List;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Lkotlin/jvm/JvmClassMappingKt;->getLastIndex(Ljava/util/List;)I
...
.method public static final plus(Ljava/lang/Iterable;Ljava/lang/Iterable;)Ljava/util/ArrayList;
    .locals 1
    ...
    invoke-static {p1, v0}, Lkotlin/collections/CollectionsKt__ReversedViewsKt;->addAll(Ljava/lang/Iterable;Ljava/util/Collection;)V

    return-object v0
.end method

.method public static final plus(Ljava/lang/Iterable;Ljava/lang/Object;)Ljava/util/ArrayList;
    .locals 1
    ...
    invoke-static {p1, p0}, Lkotlin/collections/CollectionsKt___CollectionsKt;->plus(Ljava/lang/Object;Ljava/util/Collection;)Ljava/util/ArrayList;
...
.method public static final plus(Ljava/lang/Iterable;Ljava/util/Collection;)Ljava/util/ArrayList;
    .locals 3
...
.method public static final plus(Ljava/lang/Object;Ljava/util/Collection;)Ljava/util/ArrayList;
    .locals 2
...
.method public static final sorted(Ljava/util/AbstractList;)Ljava/util/List;
    .locals 3
...
.method public static final take(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    :cond_5
    invoke-static {v2}, Lkotlin/jvm/JvmClassMappingKt;->optimizeReadOnlyList(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p0, p1, v0}, Landroidx/work/NetworkType$EnumUnboxingLocalUtility;->m(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method public static final toIntArray(Ljava/util/ArrayList;)[I
    .locals 4
...
.method public static final toLongArray(Ljava/util/ArrayList;)[J
    .locals 5
...
.method public static final toMutableList(Ljava/util/Collection;)Ljava/util/ArrayList;
    .locals 1
...
.method public static final toMutableList(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/CollectionsKt___CollectionsKt;->toCollection(Ljava/lang/Iterable;Ljava/util/AbstractCollection;)V
...
.method public static final toSet(Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/CollectionsKt___CollectionsKt;->toCollection(Ljava/lang/Iterable;Ljava/util/AbstractCollection;)V
...
.method public static final withIndex(Ljava/lang/Iterable;)Lkotlin/collections/IndexingIterable;
    .locals 3
...
.method public static final zip(Ljava/lang/Iterable;Ljava/lang/Iterable;)Ljava/util/ArrayList;
    .locals 4
