...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-static {p1, v1, v3}, Lkotlin/io/ExceptionsKt;->getColorStateList(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
...
.method public final getFontAsync(Landroid/content/Context;Landroidx/emoji2/text/EmojiCompat$InitCallback;)V
    .locals 8
    ...
    invoke-virtual {p2, p0, v0}, Landroidx/emoji2/text/EmojiCompat$InitCallback;->onFontRetrieved(Landroid/graphics/Typeface;Z)V
    ...
    invoke-direct {v5, p0, p2}, Lcom/google/android/material/resources/TextAppearance$1;-><init>(Lcom/google/android/material/resources/TextAppearance;Landroidx/emoji2/text/EmojiCompat$InitCallback;)V
    ...
    invoke-virtual {v5, p1}, L_COROUTINE/_BOUNDARY;->callbackFailAsync(I)V
    ...
    invoke-virtual {p2, p0}, Landroidx/emoji2/text/EmojiCompat$InitCallback;->onFontRetrievalFailed(I)V
    ...
    invoke-virtual {p2, v0}, Landroidx/emoji2/text/EmojiCompat$InitCallback;->onFontRetrievalFailed(I)V
...
.method public final shouldLoadFontSynchronously(Landroid/content/Context;)Z
    ...
    invoke-static/range {v0 .. v6}, Landroidx/core/content/res/ResourcesCompat;->loadFont(Landroid/content/Context;ILandroid/util/TypedValue;IL_COROUTINE/_BOUNDARY;ZZ)Landroid/graphics/Typeface;
...
.method public final updateDrawState(Landroid/content/Context;Landroid/text/TextPaint;Landroidx/emoji2/text/EmojiCompat$InitCallback;)V
    .locals 1

    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/resources/TextAppearance;->updateMeasureState(Landroid/content/Context;Landroid/text/TextPaint;Landroidx/emoji2/text/EmojiCompat$InitCallback;)V
...
.method public final updateMeasureState(Landroid/content/Context;Landroid/text/TextPaint;Landroidx/emoji2/text/EmojiCompat$InitCallback;)V
    .locals 1
    ...
    invoke-direct {v0, p0, p1, p2, p3}, Lcom/google/android/material/resources/TextAppearance$2;-><init>(Lcom/google/android/material/resources/TextAppearance;Landroid/content/Context;Landroid/text/TextPaint;Landroidx/emoji2/text/EmojiCompat$InitCallback;)V

    invoke-virtual {p0, p1, v0}, Lcom/google/android/material/resources/TextAppearance;->getFontAsync(Landroid/content/Context;Landroidx/emoji2/text/EmojiCompat$InitCallback;)V
...
.method public final updateTextPaintMeasureState(Landroid/content/Context;Landroid/text/TextPaint;Landroid/graphics/Typeface;)V
    ...
    invoke-static {p1, p3}, Ljms/IJobMgrService$_Parcel;->maybeCopyWithFontWeightAdjustment(Landroid/content/res/Configuration;Landroid/graphics/Typeface;)Landroid/graphics/Typeface;
