...
.method public static cache(Ljava/lang/String;Ljava/util/concurrent/Callable;Lcom/airbnb/lottie/LottieTask$$ExternalSyntheticLambda0;)Lcom/airbnb/lottie/LottieTask;
    .locals 5
    ...
    new-instance v4, Landroidx/work/impl/utils/IdGenerator$$ExternalSyntheticLambda0;

    invoke-direct {v4, v1, v2}, Landroidx/work/impl/utils/IdGenerator$$ExternalSyntheticLambda0;-><init>(Ljava/lang/Object;I)V

    invoke-direct {v0, v4, v3}, Lcom/airbnb/lottie/LottieTask;-><init>(Ljava/util/concurrent/Callable;Z)V
    ...
    invoke-virtual {p2}, Lcom/airbnb/lottie/LottieTask$$ExternalSyntheticLambda0;->run()V
    ...
    invoke-direct {p2, p1, v3}, Lcom/airbnb/lottie/LottieTask;-><init>(Ljava/util/concurrent/Callable;Z)V
    ...
    invoke-direct {v0, p0, p1, v3}, Lcom/airbnb/lottie/LottieCompositionFactory$$ExternalSyntheticLambda0;-><init>(Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicBoolean;I)V

    monitor-enter p2

    :try_start_0
    iget-object v3, p2, Lcom/airbnb/lottie/LottieTask;->result:Lcom/airbnb/lottie/LottieResult;
    ...
    invoke-virtual {v0, v3}, Lcom/airbnb/lottie/LottieCompositionFactory$$ExternalSyntheticLambda0;->onResult(Ljava/lang/Object;)V

    :cond_5
    iget-object v3, p2, Lcom/airbnb/lottie/LottieTask;->successListeners:Ljava/util/LinkedHashSet;
    ...
    invoke-direct {v0, p0, p1, v2}, Lcom/airbnb/lottie/LottieCompositionFactory$$ExternalSyntheticLambda0;-><init>(Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicBoolean;I)V
    ...
    :cond_6
    iget-object v3, p2, Lcom/airbnb/lottie/LottieTask;->failureListeners:Ljava/util/LinkedHashSet;
...
.method public static fromRawResSync(Landroid/content/Context;Ljava/lang/String;I)Lcom/airbnb/lottie/LottieResult;
    ...
    :try_start_1
    invoke-virtual {v0}, Lokio/RealBufferedSource;->peek()Lokio/RealBufferedSource;
    ...
    invoke-direct {v2, v0, v1}, Lokio/Buffer$2;-><init>(Lokio/BufferedSource;I)V
    ...
    :cond_2
    new-instance p0, Lokio/Buffer$2;

    invoke-direct {p0, v0, v1}, Lokio/Buffer$2;-><init>(Lokio/BufferedSource;I)V
...
.method public static fromZipStreamSyncInternal(Landroid/content/Context;Ljava/util/zip/ZipInputStream;Ljava/lang/String;)Lcom/airbnb/lottie/LottieResult;
    ...
    invoke-direct {v2, v4}, Lcom/airbnb/lottie/parser/moshi/JsonUtf8Reader;-><init>(Lokio/RealBufferedSource;)V
