...
.field public static final STRAIGHT_PATH_MOTION:L_COROUTINE/ArtificialStackFrames;
...
.field public mEpicenterCallback:Landroidx/work/WorkManager;
...
.field public mPathMotion:L_COROUTINE/ArtificialStackFrames;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/transition/Transition;->STRAIGHT_PATH_MOTION:L_COROUTINE/ArtificialStackFrames;
...
.method public constructor <init>()V
    ...
    sget-object v0, Landroidx/transition/Transition;->STRAIGHT_PATH_MOTION:L_COROUTINE/ArtificialStackFrames;

    iput-object v0, p0, Landroidx/transition/Transition;->mPathMotion:L_COROUTINE/ArtificialStackFrames;
...
.method public static addViewValues(Landroidx/work/WorkQuery;Landroid/view/View;Landroidx/transition/TransitionValues;)V
    ...
    invoke-static {p2, v3, v1, v2}, Landroidx/core/util/DebugUtils;->binarySearch([JIJ)I
...
.method public final clearValues(Z)V
    ...
    iget-object p1, p1, Landroidx/work/WorkQuery;->mIds:Ljava/lang/Object;
    ...
    iget-object p1, p1, Landroidx/work/WorkQuery;->mUniqueWorkNames:Ljava/lang/Object;

    check-cast p1, Landroid/util/SparseArray;

    invoke-virtual {p1}, Landroid/util/SparseArray;->clear()V

    iget-object p0, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/work/WorkQuery;
    ...
    iget-object p0, p0, Landroidx/transition/Transition;->mEndValues:Landroidx/work/WorkQuery;
...
.method public createAnimators(Landroid/view/ViewGroup;Landroidx/work/WorkQuery;Landroidx/work/WorkQuery;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    invoke-direct {v4, v1}, Landroidx/transition/TransitionValues;-><init>(Landroid/view/View;)V

    move-object/from16 v15, p3

    iget-object v5, v15, Landroidx/work/WorkQuery;->mIds:Ljava/lang/Object;
    ...
    iget-object v2, v4, Landroidx/transition/TransitionValues;->values:Ljava/util/HashMap;
    ...
    iget-object v0, v5, Landroidx/transition/TransitionValues;->values:Ljava/util/HashMap;
    ...
    invoke-virtual {v8, v3, v5}, Landroidx/collection/SimpleArrayMap;->getOrDefault(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Landroidx/transition/Transition$AnimationInfo;

    iget-object v11, v3, Landroidx/transition/Transition$AnimationInfo;->mValues:Landroidx/transition/TransitionValues;

    if-eqz v11, :cond_7

    iget-object v11, v3, Landroidx/transition/Transition$AnimationInfo;->mView:Landroid/view/View;

    if-ne v11, v1, :cond_7

    iget-object v11, v3, Landroidx/transition/Transition$AnimationInfo;->mName:Ljava/lang/String;

    iget-object v5, v6, Landroidx/transition/Transition;->mName:Ljava/lang/String;
    ...
    invoke-direct {v3, v7}, Landroidx/transition/WindowIdApi18;-><init>(Landroid/view/View;)V
    ...
    invoke-virtual {v8, v11, v7}, Landroidx/collection/SimpleArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public runAnimators()V
    ...
    invoke-direct {v3, p0, v0}, Landroidx/transition/Transition$2;-><init>(Ljava/lang/Object;Landroidx/collection/ArrayMap;)V
...
.method public setEpicenterCallback(Landroidx/work/WorkManager;)V
    .locals 0

    iput-object p1, p0, Landroidx/transition/Transition;->mEpicenterCallback:Landroidx/work/WorkManager;
...
.method public setPathMotion(L_COROUTINE/ArtificialStackFrames;)V
    .locals 0

    if-nez p1, :cond_0

    sget-object p1, Landroidx/transition/Transition;->STRAIGHT_PATH_MOTION:L_COROUTINE/ArtificialStackFrames;

    :cond_0
    iput-object p1, p0, Landroidx/transition/Transition;->mPathMotion:L_COROUTINE/ArtificialStackFrames;
...
.method public toString(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 18
    invoke-static {p1, p0}, Landroidx/work/NetworkType$EnumUnboxingLocalUtility;->m(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
